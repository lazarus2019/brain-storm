---
title: Vite — Ultimate Deep-Dive Guide
description:
  Vite — Ultimate Deep-Dive Guide. Practical guide explaining vite — ultimate
  deep-dive guide with clear examples, best practices and common pitfalls for...
slug: vite
...
seo:
  title: Vite — Ultimate Deep-Dive Guide
  description:
    Vite — Ultimate Deep-Dive Guide. Practical guide explaining vite —
    ultimate deep-dive guide with clear examples, best practices and common pitfalls
    for...
  canonical: https://feel-free.com/blogs/vite
  keywords:
    - vite
author: lazarus2019
lang: en
          ...
          tags: [
            {
              ...
              attrs: {
                name: 'build-version',
                content: process.env.npm_package_version || 'dev',
              },
              injectTo: 'head',
            },
          ],
...
- **Answer**:
  ...
  function timingPlugin(): Plugin {
    ...
    return {
      name: 'timing',
      buildStart() {
        times.buildStart = performance.now();
      },
      transform(code, id) {
      ...
      closeBundle() {
        console.log(
          'Total build time:',
          performance.now() - times.buildStart,
          'ms',
        );
      },
    };
